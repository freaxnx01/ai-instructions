Review the implemented component against approved wireframe, flow diagrams, and project conventions (Phase 4 of 4). Stack-neutral — cross-reference component-library preferences and file-layout rules against the active stack overlay (`.ai/stacks/<stack>.md`).
